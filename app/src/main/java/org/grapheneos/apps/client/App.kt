...
class App : Application() {
    ...
    private val appsChangesReceiver: BroadcastReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            ...
            val latestVersion = info.packageVariant.versionCode.toLong()
    ...
    fun refreshMetadata(force: Boolean = false, callback: (error: MetadataCallBack) -> Unit) {
        if (packagesInfo.isNotEmpty() && !force && this::refreshJob.isInitialized && refreshJob.isActive
                    ...
                    response.packages.forEach {
                        ...
                        val info = packagesInfo.getOrDefault(
                            ...
                            PackageInfo(
                                ...
                                packageVariant = value.variants[0],
            ...
            packagesInfo[pkgName] = pkgInfo
                .withUpdatedSession(
                    ...
                    InstallStatus.Installing(
                        true,
                        pkgInfo.packageVariant.versionCode.toLong(),
                        true
                    )
                )
            updateLiveData()
    ...
    fun handleOnClick(
        ...
        val variant = packagesInfo[pkgName]?.packageVariant
